...
export default function Footer() {
  ...
  return (
    <>
      <a
        href="https://wa.me/442036339518?text=Hi%2C%20I%27d%20like%20to%20find%20out%20more%20about%20Veridian%20Clinic."
        target="_blank"
      ...
      <footer style={{ background: "var(--sl)", padding: "56px 24px 40px", textAlign: "center" }}>
        <div className="wrap" style={{ maxWidth: 980 }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 18, justifyContent: "center", marginBottom: 28 }}>
            ...
            <Link href="/private-gp-north-west-london" style={{ fontSize: ".92rem", color: "rgba(246,241,232,.75)", textDecoration: "underline", textDecorationColor: "rgba(246,241,232,.25)" }}>
          ...
          <p style={{ fontSize: ".8rem", color: "rgba(246,241,232,.5)", marginBottom: 8 }}>
            ...
            <a href="https://wa.me/442036339518?text=Hi%2C%20I%20found%20Veridian%20Clinic%20online%20and%20I%27d%20like%20to%20find%20out%20more." target="_blank" rel="noopener noreferrer" style={{ color: "rgba(246,241,232,.7)", textDecoration: "underline" }}>
              WhatsApp
            </a>
          </p>
