...
import { WHATSAPP_NUMBER, WHATSAPP_MESSAGE } from "@/lib/siteConfig";
  ...
  return (
    <div style={{
      ...
      <a
        ...
        aria-label="Message Veridian Clinic on WhatsApp"
        ...
        onMouseDown={e => { (e.currentTarget as HTMLAnchorElement).style.transform = "scale(0.93)"; }}
