...
export const PANELS: Panel[] = [
  ...
  },
  {
    ...
    supplier: {
      female: {
        ...
        notes:
          "Trade £161.40, 57.0% margin at £375. REMOVED Vitamin D (25OH_VITD): HSC7F_RP7 already contains it. Old order was £188.20. HSC7F_RP7 gives total Testosterone, SHBG and FAI (Free Androgen Index), and free testosterone is CALCULATED from total T and SHBG, never directly assayed, so copy must say 'free testosterone (calculated)'. Also included: Oestradiol, FSH, LH, Progesterone, Prolactin, TSH/FT3/FT4 with Anti-Tg and Anti-TPO, full blood count, HbA1c, CA-125, liver, kidney and eGFR. Contains NO cortisol, so do not claim cortisol on this panel (CORTISOL is £32.40 if Dr Tosin wants the claim back).",
      },
    },
  },
  {
  ...
  {
    slug: "gp-consultation-15",
    productName: "Private GP Consultation, 15 minutes",
    positioningLine: "15-minute GP video consultation",
    pricePence: GBP(59),
    landingPage: "/gp-consultations",
    checkoutTier: "gp-consultation-15",
    thanksDocServiceId: 334,
    targetKeyword: "private gp video consultation uk",
    adGroup: "Private GP",
    status: "live",
    kind: "consultation",
    supplier: {},
  ...
  {
    slug: "gp-consultation-20",
    productName: "Private GP Consultation, 20 minutes",
    positioningLine: "20-minute GP video consultation",
    pricePence: GBP(89),
    landingPage: "/gp-consultations",
    checkoutTier: "gp-consultation-20",
    thanksDocServiceId: 335,
    targetKeyword: "private gp appointment uk",
    adGroup: "Private GP",
    status: "live",
    kind: "consultation",
    supplier: {},
