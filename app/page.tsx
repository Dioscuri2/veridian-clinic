...
const faqs = [
  ...
  { q:"Do you offer medication for weight management or blood sugar control?", a:"Where it is clinically indicated, prescribing pathways may be available through ThanksDoc's registered clinical structure, never as an isolated shortcut and always as part of a structured programme. Any specific treatment is decided with the doctor in consultation, and a prescription is never guaranteed." },
          ...
          <div className="wrap">
            ...
            <div className="gproc">
              {[
                ...
                { n:"03", t:"Personalised Plan", d:"A written, prioritised plan built around your data. CGM, nutrition, movement and behaviour protocols. Where it is clinically indicated, prescribing pathways are available, decided with the doctor in consultation." },
