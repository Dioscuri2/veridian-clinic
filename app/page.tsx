...
const insightPlaceholders = [
 ...
 { title: "Why Fasting Insulin is the Missing Link in Longevity", category: "Metabolic Health", href: "#newsletter", cta: "Notify me when this goes live →", label: "Placeholder", body: "A concise, evidence-led explainer is on the way. Expect practical interpretation, biomarker context and clear clinical takeaways." },
 { title: "ApoB vs LDL: The Real Cardiovascular Risk Marker", category: "Cardiovascular Risk", href: "#newsletter", cta: "Notify me when this goes live →", label: "Placeholder", body: "A concise, evidence-led explainer is on the way. Expect practical interpretation, biomarker context and clear clinical takeaways." },
 { title: "Reversing Metabolic Syndrome in 12 Weeks", category: "Clinical Protocols", href: "#newsletter", cta: "Notify me when this goes live →", label: "Placeholder", body: "A concise, evidence-led explainer is on the way. Expect practical interpretation, biomarker context and clear clinical takeaways." },
];
...
export default function HomePage() {
 ...
 <Link href="/metabolic-age" className="btn btn-go">Take the Metabolic Quiz →</Link>
 ...
 <section id="blog" className="sec bg-wh">
 <div className="wrap text-center">
 <h2 className="sh-title">Clinical Insights</h2>
 <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
 {["Fast Insulin", "ApoB vs LDL", "Reversing Metabolic Syndrome"].map(title => (
 <Link href={`/blog/${title.toLowerCase().replace(/ /g, '-')}`} key={title} className="p-6 border border-gray-200 rounded-xl hover:shadow-lg transition-shadow">
 <h3 className="text-xl font-bold">{title}</h3>
 <p className="text-sm text-gray-500 mt-2">Read research-backed insights...</p>
 </Link>
 ))}
 </div>
 </div>
