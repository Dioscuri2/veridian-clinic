        ...
        <section className="sec bg-wh">
          <div className="wrap" style={{ maxWidth: 900 }}>
            ...
            <p style={{ fontSize: "clamp(.85rem,2.3vw,.9rem)", color: "var(--sl3)", lineHeight: 1.85, textAlign: "center", marginTop: 22 }}>
              ...
              <a href="https://wa.me/442036339518?text=Hi%2C%20I%20would%20like%20to%20book%20a%20GP%20appointment." target="_blank" rel="noopener noreferrer" style={{ color: "#111111", fontWeight: 600, textDecoration: "underline" }}>020 3633 9518</a>
