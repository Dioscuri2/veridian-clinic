      ...
      >
        ...
        <div style={callout}>
          <p style={{ fontSize: ".88rem", color: "var(--sl2)", lineHeight: 1.8 }}>
            <strong style={{ color: "var(--fo)" }}>Clinical bottom line:</strong> normal glucose does not mean normal metabolism. When insulin is elevated despite a normal glucose, it means the system is working harder than it should and the window to reverse this is still wide open.
          </p>
        </div>
        ...
        <p style={paragraph}>
          HOMA-IR also tracks improvement well. A drop from 2.4 to 1.3 over twelve weeks of targeted intervention is measurable evidence that the metabolic pattern is reversing one of the most motivating data points a patient can receive.
        </p>
