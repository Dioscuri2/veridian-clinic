  ...
  return (
    <>
      ...
      >
        ...
        <p style={paragraph}>
          ApoB, Lp(a), HDL-C, non-HDL-C, total cholesterol ratio, hs-CRP, homocysteine, and blood pressure correlation markers. Lp(a) is included as standard: the genetically determined cardiovascular risk factor that NHS panels routinely omit, and the one most consequential when identified early.
        </p>
