  ...
  return (
    <>
      ...
      >
        ...
        <p style={paragraph}>
          There is one fatigue panel at Veridian, not a ladder of them. We previously offered a smaller entry-level screen alongside this one, and we withdrew it because it left out the markers that most often change our clinical advice: fasting insulin, C-peptide, vitamin D, both thyroid antibody types, full iron studies and cystatin C among them. A thinner investigation for a fatigue that has already been investigated once and missed is not a saving for the patient. Everything below is in the single £249 panel.
        </p>
