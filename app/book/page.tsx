...
function BookingFormInner() {
 ...
 <input className="form-field" name="name" placeholder="Full name" value={form.name} onChange={onChange} />
 <input className="form-field" name="email" type="email" placeholder="Email address" value={form.email} onChange={onChange} />
 ...
 <p style={{ fontSize: ".72rem", color: "var(--sl3)", lineHeight: 1.8 }}>
 This form submits to Formspree. Replace <code>YOUR_FORM_ID</code> before production use.
 </p>
 </form>
 </div>
 ...
 <p style={{ fontSize: ".76rem", fontWeight: 700, letterSpacing: ".14em", textTransform: "uppercase", color: "var(--fo)", marginBottom: 10 }}>Direct route</p>
 <p style={{ fontSize: ".84rem", color: "var(--sl2)", lineHeight: 1.85 }}>
 If you’ve already compared options, you can also go back to the <Link href="/assessments" style={{ textDecoration: "underline", color: "var(--fo)", fontWeight: 600 }}>assessments page</Link> and review them side-by-side again.
 </p>
 </div>
 </div>
 </div>
