                  ...
                  <div style={{ display: "grid", gap: 20, alignContent: "start" }}>
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: ".72rem", color: panel.featured ? "rgba(246,241,232,.4)" : "var(--sl3)", lineHeight: 1.6, marginTop: 10 }}>
                        Processed by a nationally accredited UK pathology laboratory with centres across the country. Results typically within 3 to 5 working days.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div style={{ display: "grid", gap: 20, alignContent: "start" }}>
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: ".72rem", color: "var(--sl3)", lineHeight: 1.6, marginTop: 10 }}>
                        Processed by a nationally accredited UK pathology laboratory. Results typically within 3 to 5 working days.
                      </p>
                    </div>
                  </div>
                </div>
...
export default function AssessmentsPage() {
 ...
 <section id="metabolic-panel" className="sec bg-wh" style={{ paddingTop: 56, paddingBottom: 56 }}>
   <div className="wrap" style={{ maxWidth: 860 }}>
     ...
     <p style={{ fontSize: ".76rem", color: "var(--sl3)", textAlign: "center", lineHeight: 1.7, marginTop: 20 }}>
       Not a substitute for NHS care. Results typically available within 3 to 5 working days of sample receipt.
     </p>
   </div>
 </section>
 ...
 <section id="targeted-panels" className="sec bg-wh" style={{ paddingTop: 56, paddingBottom: 56 }}>
   <div className="wrap" style={{ maxWidth: 860 }}>
     ...
     <p style={{ fontSize: ".76rem", color: "var(--sl3)", textAlign: "center", lineHeight: 1.7, marginTop: 20 }}>
       Blood test only. GP-reviewed written report included. Add a Discovery Core consultation (£127) if you&apos;d like clinical interpretation by video.
     </p>
   </div>
 </section>
