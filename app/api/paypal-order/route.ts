...
const CATALOG: Record<string, { name: string; amount: string }> = {
  "womens-hormones":    { name: "Is It My Hormones?, Women's Hormone Panel", amount: "375.00" },
  ...
  "optimiser-baseline": { name: "The Optimiser's Baseline, Performance & Longevity Panel", amount: "449.00" },
