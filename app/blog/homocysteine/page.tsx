  ...
  return (
    <>
      ...
      >
        ...
        <p style={paragraph}>
          The limitation of this position, from a preventive medicine perspective, is that the randomised trials mostly enrolled patients who already had established disease. The question of whether lowering homocysteine in primary prevention — in people who have not yet had an event — reduces future risk is a different one, and the evidence for it is more supportive. For patients trying to optimise their health before disease develops, measuring homocysteine provides useful, actionable information regardless of whether it rises to the level of a universal screening test.
        </p>

        <h2 className="cg" style={sectionHeading}>Who should consider a private homocysteine test in the UK</h2>
        <p style={paragraph}>
          In clinical practice, homocysteine testing makes particular sense in a number of contexts. These include: a personal or family history of premature cardiovascular disease or stroke, particularly in patients whose standard lipid panel does not fully explain their risk. Unexplained fatigue, brain fog, or neurological symptoms in the context of a plant-based diet or documented B12 deficiency. Patients with elevated cardiovascular risk on QRISK3 who want to extend their assessment beyond the standard panel. People taking medications known to deplete B vitamins. Anyone with a known MTHFR polymorphism who wants to know whether their nutrient status is compensating adequately.
        </p>
        <p style={paragraph}>
