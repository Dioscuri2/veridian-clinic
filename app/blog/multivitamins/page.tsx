  ...
  return (
    <>
      ...
      >
        ...
        <p style={paragraph}>
          The view that multivitamins are a waste of money became dominant in medicine for a reason. Several large observational studies and earlier trials failed to show benefit for well-nourished adults. The supplement industry had consistently overclaimed what a multivitamin could do. The logic seemed sound. If you eat a reasonable diet, supplementing with a broad-spectrum low-dose product should not make much difference. For truly well-nourished people, that may still be broadly true.
        </p>
        <p style={paragraph}>
