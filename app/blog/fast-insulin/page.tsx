...
export const metadata: Metadata = {
  ...
  description:
    "Fasting insulin is one of the most clinically useful but under-requested markers in UK preventive medicine. It reveals early insulin resistance years before HbA1c or fasting glucose become abnormal — and identifies who is at risk while intervention is still most effective.",
  alternates: {
  ...
  return (
    <>
      ...
      >
        ...
        <p style={paragraph}>
          <strong>Energy and cognition:</strong> the energy instability many patients describe — afternoon crashes, poor concentration, carbohydrate cravings — maps directly onto the glucose variability that accompanies insulin resistance. Glucose rises sharply after meals, triggers a large insulin response, and falls more steeply than it should. CGM data often confirms this pattern in people who assume their energy symptoms are just "normal."
        </p>
        ...
        <ul className="chk">
          ...
          <li>Anyone with triglycerides above 1.5 mmol/L on a standard lipid panel — elevated TG is often the earliest lipid signal of insulin resistance.</li>
          <li>Women with PCOS — insulin resistance is present in 65–80% of PCOS cases and drives the hormonal dysregulation, yet fasting insulin is not routinely tested in most NHS PCOS workups.</li>
