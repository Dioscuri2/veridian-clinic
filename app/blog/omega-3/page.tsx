  ...
  return (
    <>
      ...
      >
        ...
        <p style={paragraph}>
          EPA and DHA are precursors to a class of signalling molecules called resolvins, protectins, and maresins. Unlike conventional anti-inflammatory drugs, which primarily suppress inflammatory signals, these specialised pro-resolving mediators actively terminate inflammatory processes once they have served their biological purpose. Chronic inflammation is often a failure of resolution rather than too much inflammatory signal. Omega-3 fatty acids support the resolution step that conventional anti-inflammatory approaches do not address.
        </p>
        <p style={paragraph}>
