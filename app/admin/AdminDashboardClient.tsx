...
• Discovery Core £127 (30 min with Dr Taiwo)
...
Most patients start with Discovery Core it's the best way to find out which package fits your goals. Would you like to know more about any specific service?`,
  },
  {
    ...
    body: `Our Discovery Core consultation (£127, 30 minutes with Dr Taiwo) is the best starting point. We'll review your health history, current symptoms, and goals then design a personalised plan.
...
If you're not sure which service to start with, Discovery Core (£127) is the right first step Dr Taiwo will assess your situation and recommend the best path forward.
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "28px" }}>
                  <div style={{ background: "#1a1916", border: "1px solid #2a2820", borderRadius: "10px", padding: "22px" }}>
                    ...
                    {[
                      ...
                      { stage: "Discovery Core (£97-£127)", count: stats.funnel.discoveryCalls, colour: "#145226" },
