        ...
        <section className="sec" style={{ background: "var(--iv2)" }}>
          <div className="wrap" style={{ maxWidth: 980 }}>
            <div style={{
              ...
              <h2 style={{ fontSize: "clamp(1.4rem,3vw,1.9rem)", fontWeight: 500, color: "var(--sl)", marginTop: 20, marginBottom: 12 }}>
                ThanksDoc Privacy Policy
              </h2>
              <p style={{ fontSize: ".9rem", color: "var(--sl2)", lineHeight: 1.8, maxWidth: 560, margin: "0 auto 28px" }}>
                Registered clinical activities at Veridian Clinic are delivered via ThanksDoc (Endura Health Ltd),
                who act as a separate data controller for health information processed in clinical care.
                Their full privacy policy is published and kept up to date on their website.
              </p>
              <a
                href="https://thanksdoc.co.uk/privacy-policy/"
                target="_blank"
                rel="noopener noreferrer"
                className="btn btn-fo"
                style={{ display: "inline-flex" }}
              >
                View ThanksDoc Privacy Policy →
              </a>
